  ...
  $action=$_POST['mode'];
    ...
    if($action=="getOrgs"){
      ...
      if($result){
        ...
        // заганяем массив цыфровые индексы, для предотвращения сортировки. И обрезки ненужного
        $arrHed=array();
    ...
    foreach ($arrfild as $key => $value) {
      switch (mb_strtolower($value)) {
        case 'kd':
          $headTable["kd"]['type']="N";
          $headTable["kd"]['len']=8;
          $headTable["kd"]['hNu']="ЄДРПОУ";
          $filds[0][]="t1.kd";
        break;
        case 'kdmo':
          $headTable["kdmo"]['type']="N";
          $headTable["kdmo"]['len']=12;
          $headTable["kdmo"]['hNu']="КДМО";
          $filds[0][]="t1.kdmo";
        break;
        case 'nu':
          $headTable["nu"]['type']="C";
          $headTable["nu"]['len']=250;
          $headTable["nu"]['hNu']="Назва";
          $filds[0][]="t1.nu";
        break;
        case 'pk':
          $headTable["pk"]['type']="C";
          $headTable["pk"]['len']=45;
          $headTable["pk"]['hNu']="Керівник";
          $filds[0][]="t1.pk";
        break;
        case 'kdg':
          $headTable["kdg"]['type']="N";
          $headTable["kdg"]['len']=8;
          $headTable["kdg"]['hNu']="Голловне<br>підприємство";
          $filds[0][]="t1.kdg";
        break;
        case 'te':
          $headTable["te"]['type']="N";
          $headTable["te"]['len']=10;
          $headTable["te"]['hNu']="Код території";
          $filds[0][]="t1.te";
        break;
        case 'tea':
          $headTable["tea"]["type"]="N";
          $headTable["tea"]["len"]=5;
          $headTable["tea"]['hNu']="Адмінмістративна<br>належність";
          $filds[0][]="t1.tea";
        break;
        case 'ad':
          $headTable["ad"]["type"]="C";
          $headTable["ad"]["len"]=150;
          $headTable["ad"]['hNu']="Адреса";
          $filds[0][]="t1.ad";
        break;
        case 'pi':
          $headTable["pi"]["type"]="N";
          $headTable["pi"]["len"]=6;
          $headTable["pi"]['hNu']="Поштовий<br>індекс";
          $filds[0][]="t1.pi";
        break;
        case 'pf':
          $headTable["pf"]['type']="N";
          $headTable["pf"]['len']=3;
          $headTable["pf"]['hNu']="Код організаційної<br>форми";
          $filds[0][]="t1.pf";
        break;
        case 'pf_nu':
          $headTable["pf_nu"]['type']="C";
          $headTable["pf_nu"]['len']=100;
          $headTable["pf_nu"]['hNu']="Назва організаційної<br>форми";
          $filds[0][]="t4.nu as pf_nu";
        break;
        case 'gu':
          $headTable["gu"]['type']="N";
          $headTable["gu"]['len']=5;
          $headTable["gu"]['hNu']="Орган <br> управління";
          $filds[0][]="t1.gu";
        break;
        case 'uo':
          $headTable["uo"]['type']="N";
          $headTable["uo"]['len']=1;
          $headTable["uo"]['hNu']="Ознака <br> особи ";
          $filds[0][]="t1.uo";
        break;
        case 'dl':
          $headTable["dl"]['type']="N";
          $headTable["dl"]['len']=8;
          $headTable["dl"]['hNu']="Дата<br>ліквідації";
          $filds[0][]="t1.dl";
        break;
        case 'kise':
          $headTable["kice"]['type']="N";
          $headTable["kice"]['len']=4;
          $headTable["kice"]['hNu']="Сектор <br> економіки";
          $filds[0][]="t1.kice";
        break;
        case 'iz':
          $headTable["iz"]['type']="N";
          $headTable["iz"]['len']=1;
          $headTable["iz"]['hNu']="Іноземний <br> засновник";
          $filds[0][]="t1.iz";
        break;
        case 'e1_10':
          $headTable["e1_10"]["type"]="C";
          $headTable["e1_10"]['len']=5;
          $headTable["e1_10"]['hNu']="Код в.д.1<br>KVED10";
          $filds[0][]="t1.e1_10";
        break;
        case 'ne1_10':
          $headTable["ne1_10"]["type"]="C";
          $headTable["ne1_10"]['len']=250;
          $headTable["ne1_10"]['hNu']="Назва в.д.1";
          $filds['1'][]="ne1_10";
        ...
        case 'e2_10':
          ...
          $headTable["e2_10"]['hNu']="Код в.д. 2<br>KVED10";
          $filds[0][]="t1.e2_10";
        break;
        case 'ne2_10':
          $headTable["ne2_10"]["type"]="C";
          $headTable["ne2_10"]["len"]=250;
          $headTable["ne2_10"]['hNu']="Назва в.д. 2";
          $filds[1][]="ne2_10";
        ...
        case 'e3_10':
          ...
          $headTable["e3_10"]['hNu']="Код в.д. 3 <br>KVED10";
          $filds[0][]="t1.e3_10";
        break;
        case 'ne3_10':
          $headTable["ne3_10"]["type"]="C";
          $headTable["ne3_10"]["len"]=250;
          $headTable["ne3_10"]['hNu']="Назва в.д. 3";
          $filds[1][]="ne3_10";
        ...
        case 'e4_10':
          ...
          $headTable["e4_10"]['hNu']="Код в.д. 4 <br>KVED10";
          $filds[0][]="t1.e4_10";
        break;
        case 'ne4_10':
          $headTable["ne4_10"]["type"]="C";
          $headTable["ne4_10"]["len"]=250;
          $headTable["ne4_10"]['hNu']="Назва в.д. 4 ";
          $filds[1][]="ne4_10";
        ...
        case 'e5_10':
          ...
          $headTable["e5_10"]['hNu']="Код в.д. 5 <br>KVED10";
          $filds[0][]="t1.e5_10";
        break;
        case 'ne5_10':
          $headTable["ne5_10"]["type"]="C";
          $headTable["ne5_10"]["len"]=250;
          $headTable["ne5_10"]['hNu']="Назва в.д. 5";
          $filds[1][]="ne5_10";
        ...
        case 'e6_10':
          ...
          $headTable["e6_10"]['hNu']="Код в.д. 6 <br>KVED10";
          $filds[0][]="t1.e6_10";
        break;
        case 'ne6_10':
          $headTable["ne6_10"]["type"]="C";
          $headTable["ne6_10"]["len"]=250;
          $headTable["ne6_10"]['hNu']="Назва в.д 6 ";
          $filds[1][]="ne6_10";
        ...
        case 'vdf10':
          ...
          $headTable["vdf10"]['hNu']="Код факт. в.д. <br>KVED10";
          $filds[0][]="t1.vdf10";
        break;
        case 'n_vdf10':
          $headTable["n_vdf10"]["type"]="C";
          $headTable["n_vdf10"]["len"]=250;
          $headTable["n_vdf10"]['hNu']="Назва факт. в.д.";
          $filds[1][]="n_vdf10";
        ...
        case 'rn':
          $headTable["rn"]["type"]="C";
          $headTable["rn"]["len"]=17;
          $headTable["rn"]['hNu']="Ост. реєстраційна  <br> дія";
          $filds[0][]="t1.rn";
        break;
        case 'dr':
          $headTable["dr"]['type']="N";
          $headTable["dr"]['len']=8;
          $headTable["dr"]['hNu']="Дата  реєстраційних <br> дій";
          $filds[0][]="t1.dr";
        break;
        case 'dz':
          $headTable["dz"]['type']="N";
          $headTable["dz"]['len']=8;
          $headTable["dz"]['hNu']="Дата внес. змін <br> до ЄДРПОУ ";
          $filds[0][]="t1.dz";
        break;
        case 'pr':
          $headTable["pr"]['type']="N";
          $headTable["pr"]['len']=1;
          $headTable["pr"]['hNu']="Тип змін";
          $filds[0][]="t1.pr";
        break;
        case 'phone':
          $headTable["phone"]["type"]="C";
          $headTable["phone"]['len']=200;
          $headTable["phone"]['hNu']="Телефони";
        break;
        case 'phacs':
          $headTable["phacs"]["type"]="C";
          $headTable["phacs"]['len']=200;
          $headTable["phacs"]['hNu']="Факс";
        break;
        case 'mail':
          $headTable["mail"]["type"]="C";
          $headTable["mail"]['len']=200;
          $headTable["mail"]['hNu']="Електронні адреси";
        break;
        case 'sof':
          $headTable["sof"]["type"]="N";
          $headTable["sof"]['len']=3;
          $headTable["sof"]['hNu']="Код СКОФ";
          $filds[0][]="t1.sof";
        break;
        case 'sof_nu':
          $headTable["sof_nu"]["type"]="C";
          $headTable["sof_nu"]['len']=200;
          $headTable["sof_nu"]['hNu']="Назва коду <br> СКОФ";
