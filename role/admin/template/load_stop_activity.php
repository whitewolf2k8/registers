...
<script type="text/javascript">
  ...
  function cleanFormSearch() {
    ...
    document.getElementById("filtr_data_type").value="";
    submitForm("");
  }
...
<body>
  ...
  <div class="wrapper">
      ...
      <div class="mainConteiner">
        ...
        <h2>Інформація про призупинення діяльності</h2>

        <form name="adminForm" action="load_stop_activity.php" method="post" enctype="multipart/form-data">
          ...
          <div class="item_blue" style="float:right;margin-right:15%; width:320px;">
  	        <h2>Пошук</h2>
            <p>
          	   <div class="navigation_left">Пошук по ЄДПРОУ</div>
            ...
            <div class="clr"></div>
            <p>
               <div class="navigation_left">Пошук номер/дата</div>
               <div class="navigation_right"><input align="right" type="text" id="filtr_data_type" name="filtr_data_type" value="<?php echo $filtr_data_type; ?>" style="width:180px;text-align:center;" /></div>
            </p>
            <div class="clr"></div>
            <p align="center">
  	          <input type="button" value="Пошук" class="button" onclick="submitForm('')" />
              <input type="button" value="Очистити" id="delBtn" class="button" onclick="cleanFormSearch()" />
  	        </p>
  	    	</div>
