...
<script src="../../../js/script_select_org_by_pk.js"></script>
</head>
...
<body>
  ...
  <div class="wrapper">
      ...
      <div class="mainConteiner">
        <h2>Вибірка підприємств по керівнику</h2>
        ...
        <form name="adminForm" id="adminForm" action="selection_org_by_pk.php" method="post" enctype="multipart/form-data">
          ...
          <div class="item_blue" style="position: relative; width: 880px; left: 50%; margin-left: -440px;">
            ...
            <h2 style="text-align:center;" > Вибірка: </h2>
            <p class="act_add">
              <span>Керівник <input type="text"  placeholder="Керівник" id="pkNu"  name="pkNu" style="width:77%;" /></span>
              <span><input type="button"  class="button" value="Пошук" onclick="searhOrgs()"/></span>
            </p>
            <div class="clr"></div>
