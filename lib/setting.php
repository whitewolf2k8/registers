<?
  ...
  $fildListDb=array(array('nu'=>"KD",'typeL'=>"number",'typeS'=>'N','len'=>8,'lenAftedot'=>0,'de'=>"Ідентифікаційник код ЄДРПОУ"),
    ...
    array('nu'=>"PK",'typeL'=>"character",'typeS'=>'C','len'=>45,'de'=>"Прызвище керывника"),
    ...
    array('nu'=>"OT",'typeL'=>"number",'typeS'=>'N','len'=>11,'lenAftedot'=>0,'de'=>"Телефон"),
    array('nu'=>"OF",'typeL'=>"number",'typeS'=>'N','len'=>11,'lenAftedot'=>0,'de'=>"Факс"),
    array('nu'=>"EMAIL",'typeL'=>"character",'typeS'=>'C','len'=>38,'de'=>"Адреса електронної пошти"),
